...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const xp = computeXp({ debts, bodyMetrics, workouts, personalityCheckins, nutritionToday, journalEntries });
...
function computeXp({ debts, bodyMetrics, workouts, personalityCheckins, nutritionToday, journalEntries }) {
